    ...
    return (
        <div className='flex flex-col h-screen text-center'>
            <Link to='/'><img className='mx-auto' src={'https://1000marcas.net/wp-content/uploads/2022/04/Rick-and-Morty.png'} alt='Rick&Morty' width={'300'} /></Link>
            {
                !loader 
                ?
            <div className="mx-auto my-auto bg-transparent card cardContainerDetail card-side">
                <figure><img className='cardetail' src={character.image} alt={character.name} /></figure>
                <div className="card-body">
                    <h2 className="lg:text-2xl card-title textShadow">{character.name}</h2>
                    <ul className='text-start'>
                        ...
                        <li className='py-1 textShadow'><span className='text-blue-400 textShadow'>Gender: </span>{character.gender === 'Male' && <i className="text-xl fa-solid fa-person text-primary"></i>} {character.gender === 'Female' && <i className="text-xl fa-solid fa-person-dress text-accent"></i>} {character.gender === 'unknown' && <i className="text-xl fa-solid fa-question text-warning"></i>}</li>
